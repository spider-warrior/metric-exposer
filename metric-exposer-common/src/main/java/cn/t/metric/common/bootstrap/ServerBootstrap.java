...
public class ServerBootstrap {
    public static void bind(String bindAddress, int bindPrt, ChannelInitializer subChannelInitializer, SingleThreadEventLoop acceptLoop, SingleThreadEventLoop workerLoop) throws Exception {
        ...
        // 注册accept事件
        acceptLoop.register(serverSocketChannel, SelectionKey.OP_ACCEPT, new ServerSocketChannelInitializer(subChannelInitializer, workerLoop)).addListener(future -> {
            if(future.isSuccess()) {
                // 监听就绪
